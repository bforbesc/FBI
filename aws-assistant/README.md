...
This is a **Claude Cowork skill**. Add `SKILL.md` to your Claude Cowork workspace and it activates automatically when you ask AWS-related questions.
...
- **Claude in Chrome MCP** (optional) with `mcp__Claude_in_Chrome__navigate` — for the SSO auto-login flow
- AWS credentials configured with a named profile (SSO or static)

## Setup

In `SKILL.md`, replace the two placeholders before use:
